...
def dateinator(title):
    ...
    Or a photo or video from my phone with title in the form of 'IMG_20191019_165427787.jpg'
    or 'VID_20191101_133755175.mp4'
    '''
    ...
    if (title[-3]=='w'):
        ...
        print("BIG YEET")
        year=int(title[4]+title[5])
        month=int(title[8]+title[9])
        date=int(title[10]+title[11])
        tm1=int(title[13]+title[14])
        tm2=int(title[15]+title[16])
    elif (title[-3]=='m'):
        print("BIG YEET")
        year=int(title[4]+title[5])
        month=int(title[8]+title[9])
